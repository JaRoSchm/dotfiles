...
call s:HL('pythonStatement',   defaultForeground, defaultBackground, 'bold')
call s:HL('pythonFunction',    defaultForeground, defaultBackground, 'none')
call s:HL('pythonConditional', defaultForeground, defaultBackground, 'bold')
call s:HL('pythonRepeat',      defaultForeground, defaultBackground, 'bold')
call s:HL('pythonException',   defaultForeground, defaultBackground, 'bold')
call s:HL('pythonInclude',     defaultForeground, defaultBackground, 'bold')
