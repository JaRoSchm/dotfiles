...
hi StatusLine           guifg=white     ctermfg=white           cterm=none gui=none  guibg=black   ctermbg=black
hi StatusLineNC         guifg=fg        ctermfg=fg              cterm=none gui=none  guibg=#cccbca ctermbg=white
